    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product { ProductId = 5, CategoryId = 2, ProductName = "Apple Telefon", QuantityPerUnit = "4 GB Ram", UnitPrice = 9000, UnitsInStock = 0}
            };
            ...
            LinqJoinTest(categories, products);

        }

        private static void LinqJoinTest(List<Category> categories, List<Product> products)
        {
